...
#        self.tablet.addTab(self.progress, "")
        ...
        self.menuKinetic_mechanism_optimisation_tool = QtWidgets.QMenu(self.menubar)
        self.menuKinetic_mechanism_optimisation_tool.setObjectName("menuKinetic_mechanism_optimisation_tool")
        MainWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(MainWindow)
        self.statusbar.setObjectName("statusbar")
        MainWindow.setStatusBar(self.statusbar)
        self.menubar.addAction(self.menuKinetic_mechanism_optimisation_tool.menuAction())
...
# =============================================================================
        ...
        self.menuKinetic_mechanism_optimisation_tool.setTitle(_translate("MainWindow", "&Kinetic mechanism optimisation tool"))
...
#                            self.df_eqincr_2[case_n].setPlainText(_translate("MainWindow", format((phis2[-1]-phis2[0])/div_,'.2f')))
    ...
    #            print('\r Get data from operator '+ str(op_n) + '...')
                ...
                if 'SA' in reduction_operator or 'DSRG' in reduction_operator:
                    if 'eps'            in locals():
